        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="relative ms-3">
                    <button class="p-1 text-gray-500 hover:text-gray-700 focus:outline-none focus:text-gray-700 transition duration-150 ease-in-out">
                ...
                <div class="ms-3 relative">
                    ...
                    @endphp
                    <div class="h-10 w-10 rounded-full overflow-hidden {{ $bgColor }} flex items-center justify-center text-white font-medium text-base shadow-sm">
                        {{ $initials }}
                    </div>
                </div>
